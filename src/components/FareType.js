    ...
    <div>
      <div className="fare-type">
        ...
        <div className="fare-type-child2">
          <div
            className={`fare-type-child2-child ${
              regular ? "fare-type-background" : ""
            }`}
          >
            <input
              type="radio"
              ...
              value="regular"
              defaultChecked
              onClick={(e) => fareTypeSelection(e)}
            />
            <label htmlFor="regular">Regular</label>
          </div>
          <div
            className={`fare-type-child2-child ${
              armedforces ? "fare-type-background" : ""
            }`}
          >
            <input
              type="radio"
          ...
          <div
            className={`fare-type-child2-child ${
              seniorcitizen ? "fare-type-background" : ""
            }`}
          >
            <input
              type="radio"
          ...
          <div
            className={`fare-type-child2-child ${
              doctornurse ? "fare-type-background" : ""
            }`}
          >
            <input
              type="radio"
