...
export default function From({fromcityfocus,setFromCityFocus,city,setCity}) {
      ...
      <div className="one-way-container-child">
            <div className={fromcityfocus?"from-container-focus1":"from-container"}>
              <div className={fromcityfocus?"from-container-child-focus1":"from-container-child"}>
                ...
                <input type="text" className="enter-city" onFocus={()=>setFromCityFocus(true)} onBlur={()=>setFromCityFocus(false)} onChange={(e)=>searchCity(e)} placeholder="Enter city or airport"/>
              </div>
              {listofcity!=null && <ul className="airport-list-container" onClick={()=>hello()}>
                {listofcity.map((item)=>
                  <li>
                      <div className="airport-list-container-child" onClick={(e)=>sample(e)}>
