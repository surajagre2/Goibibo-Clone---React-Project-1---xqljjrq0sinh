       ...
       <div className="one-way-container-child">
            <div className="from-container">
              <div className="departute-container-child">
                ...
                {returndate?<input type="date" className="departure-date"></input>:<p className="return-date" onClick={()=>setReturnDate(true)}>Click to add a return flight for better discounts</p>}
              </div>
            </div>
          </div>
    </div>
